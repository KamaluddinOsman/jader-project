<?php
    ...
    return[
        ...
        'institutionEmail'=>'البريد الالكتروني',
        'minOrder'=>'حد ادنى للشراء',
        'commercialRegisterNumber'=>'السجل التجاري',
        'taxRecord'=>'السجل الضريبي',
        'deliveryPrice'=>'سعر التوصيل',
        'whatsappNumber'=>'رقم الواتساب',
        'facebookAccount'=>'حساب الفيس بوك',
        'institutionWebsite'=>'الموقع الالكتروني',
        'from'=>'من',
        'to'=>'الي',

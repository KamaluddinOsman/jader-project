...
<?php
$store = \App\Store::pluck('name', 'id')->toArray();
                        ...
                        <div class="col-md-6">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputDescription">المؤسسة</label>
                                        {!! Form::select('store_id',$store,null,[
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="variety_id" id="variety" class="form-control select2">
                                            @if($records->varieties_id)
                                                    <option value="{{$records->variety->id }}">{{ $records->variety->name }}</option>
                                            @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="brand_id" id="brand" class="form-control select2">
                                            @if($records->brands_id)
                                                <option value="{{$records->brand->id }}">{{ $records->brand->name }}</option>
                                            @else
                                                <option>choose</option>
                                            @endif
                                        </select>

...
@section('head')
    @section('page-title')
        {{ __('product.product') }} - {{ __('product.rejected') }} | {{ __('auth.bageTitle') }}             
    @endsection
    <!-- DataTables -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">{{ __('product.product') }} - {{ __('product.rejected') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">{{ __('dashboard.dashboard') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('product.product') }} - {{ __('product.rejected') }}</li>
                        </ol>
                    </div>
                </div>
            </div>

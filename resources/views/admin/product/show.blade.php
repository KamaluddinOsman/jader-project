                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="col-12 product-image-thumbs">
                                        <div class="product-image-thumb active"><img src="{{asset($product->getOriginal('image1'))}}" alt="Product Image"></div>
                                        <div class="product-image-thumb" ><img src="{{asset($product->getOriginal('image2'))}}" alt="Product Image"></div>
                                        <div class="product-image-thumb" ><img src="{{asset($product->getOriginal('image3'))}}" alt="Product Image"></div>
                                        <div class="product-image-thumb" ><img src="{{asset($product->getOriginal('image4'))}}" alt="Product Image"></div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">

                    ...
                    <li class="col-md-4">
                        <figure class="itemside mb-3">
                            ...
                            <figcaption class="info align-self-center">
                                <p class="title">{{$item->name}} <br> <span style="text-decoration: line-through" class="text-muted">{{$item->pivot->original_price}} ر.س </span>  <br><span class="text-muted">{{$item->pivot->price}} ر.س </span>
                            </figcaption>
                        </figure>
                    </li>
                @endforeach

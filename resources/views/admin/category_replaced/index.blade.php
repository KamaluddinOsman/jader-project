...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-dashboard"></i> {{__('lang.category')}}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" style="margin-bottom: 8px" class="btn btn-primary"
                                                            ...
                                                            data-parentid="{{$record->parent_id}}" data-toggle="modal"
                                                ...
                                                <td>
                                                    @if($record->activated == 1)
                                                        ...
                                                        <div class="checkbox">
                                                            <input data-url="{{url('category/active/'.$record->id)}}"
                                                                data-token="{{csrf_token()}}" class="activeCheck"
                                                                name="activeCheck" type="checkbox"
                                                                data-on="{{__('lang.active')}}"
                                                                data-off="{{__('lang.block')}}" checked
                                                    ...
                                                    @else
                                                        <div class="checkbox">
                                                            <input data-url="{{url('category/active/'.$record->id)}}"
                                                                ...
                                                                name="activeCheck" type="checkbox"
                                                                data-on="{{__('lang.active')}}"
                                                                data-off="{{__('lang.block')}}" data-toggle="toggle"
    ...
    <!-- Modal -->
    <div class="modal fade" id="Addcategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle"
         aria-hidden="true">
    ...
    <!-- Modal -->
    <div class="modal fade" id="Editcategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">

...
class MoneyAccountController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.account.index')->with(compact('records'));
    }
    ...
    public function getclient($type)
    {
        ...
        $output = view('admin.account.client', ['client' => $client, 'type' => $type])->render();
    ...
    public function getAccounts(Request $request, $id)
    {
        ...
        $output = view('admin.account.accountCommission', ['remittance' => $remittance, 'rest' => $rest, 'site_money' => $site_money, 'total' => $total, 'type' => $request->type])->render();
        return response()->json([
            'output' => $output
        ]);
    }
    ...
    public function show($id){
        ...
        return view('admin.account.show', compact('trans', 'carbon', 'car', 'store', 'client', 'rest', 'site_money', 'total', 'commission'));
